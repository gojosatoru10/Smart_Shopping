...
| **bridge/hand_tuio_bridge.py** | **MediaPipe** hands → **`/tuio/2Dcur`** cursors; **DollarPy** gestures → short **`/tuio/2Dobj`** bursts (SymbolID `1`) for swipe navigation. |
...
```powershell
py -3.9 -m pip install python-osc torch winsdk pybluez2
```
